...
## Corpus Check
- 4 files · ~691,327 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2520 nodes · 4251 edges · 348 communities (169 shown, 179 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 263 edges (avg confidence: 0.79)
...
## Communities (348 total, 179 thin omitted)
...
Cohesion: 0.10
Nodes (45): Offline sync queue — localStorage queue for failed GAS POSTs, submitForm, APP_TOKEN (S6 token partagé GAS/VBA), FUEL_KEYS, GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), GOOGLE_CLIENT_ID (U7 auth), checkDuplicate() (+37 more)
...
Cohesion: 0.18
Nodes (34): viewchange event, _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), FUEL_CONFIG (+26 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (33): _allRecords, buildHistoriqueCSV(), chargerHistorique(), CSV_COLS, _csvSep(), _downloadCSV(), escapeHtml(), estPleinValide() (+25 more)
...
Cohesion: 0.16
Nodes (28): Geolocation localStorage cache TTL 1h (W31), OSM brand enrichment — single Overpass grouped query to name stations, OSM enrichment (enrichStationsBulk) — background station name resolution, showMap(), Geo localStorage cache (GEO_CACHE_KEY, 1h TTL), geolocate(), loadGeoCache(), renderComparateur() (+20 more)
...
Cohesion: 0.12
Nodes (24): Pure utility functions, detectBrand(), _close(), GMAPS_URL(), _onKey(), showStationPopup(), WAZE_URL(), brandFromAddress() (+16 more)
...
Cohesion: 0.17
Nodes (26): CHANGELOG — Suivi Conso Carburants, Artifact GAS Manager / gas-config.json, Top 5 recommandés (priorités ROADMAP), Axe Dev / Outillage Claude, Axe Excel, Axe Web app, C4 Pouvoirs navigateur Claude in Chrome, C5 Pouvoirs API Google (GAS + Sheets) (+18 more)
...
Cohesion: 0.12
Nodes (24): G1 — Listes déroulantes de saisie (validation données), ImporterNouveauxPleins (ModuleImportGS), RafraichirListesSaisie (modValidation), tbl_stationEssence (table Notes), tbl_vehicule (table Notes), Milestone v5.26.0.0 (G2 dégradé prix), _PrixHistory (relevé prix marché), Notifications push VAPID (WebPush.gs) (+16 more)
...
Cohesion: 0.19
Nodes (17): modCarte.bas (cartes Excel), v5.22.0.0, v5.23.0.0, Carte alentour / stations les moins chères (cartealentour.js), Google Maps JS (cartographie), Milestone v5.23.0.0 (W82 cartes Google Maps), vba/modCarte.bas (3 cartes Excel : stations, proximité, itinéraire), Carte interactive Google Maps (W63) + clé Maps JS + Map ID (+9 more)

### Community 46 - "Community 46"
Cohesion: 0.13
Nodes (16): S5 — suppression d'un plein accessible utilisateur, X61 — dates FR des abscisses du Tableau de bord, commit.sh (gate Lint), Gate a11y bloquant (W81) — 0 violation grave, X44 — Modularisation gros modules VBA (< 500 l.), X53 — Nettoyage code mort économie E85, Règle : retirer Attribute VB_Name avant set-module, Règle : Const mal placée = erreur compile-on-demand (+8 more)
...
Cohesion: 0.20
Nodes (15): modGraphData.bas (agrégats dashboard), modGraphiques.bas (orchestration dashboard), modGraphRender.bas (rendu graphiques/KPI), modGraphCfg.bas — config partagee Public + etat mPerDeb/mPerFin, modGraphChrome.bas, modGraphData.bas — moteur d'agregats (BuildAggregates), modGraphiques.bas (dashboard graphiques), modGraphRender.bas — rendu graphiques (Add*Chart, BuildKPICards) (+7 more)
...
Cohesion: 0.22
Nodes (13): Repli OpenStreetMap (onFallback), googleMapsEnabled(), loadClusterer(), loadGoogleMaps(), _attach(), googleMapsActive(), _inst, _priceBadge() (+5 more)
...
Cohesion: 0.23
Nodes (13): plein-added event, _getNum(), initBadges(), _markSeen(), refreshBadges(), SECTOR_FUELS, _setBadge(), _todayIso() (+5 more)
...
Cohesion: 0.27
Nodes (12): modSyncJson.bas (helpers JSON/format), modSyncParametres (dédupliqué), modGraphiques.bas (~1500 l., Phase 3 à venir), modSyncEngine.bas (moteur SyncCore + import/export), modSyncGS.bas (points d'entrée sync), modSyncJson.bas (helpers JSON purs), modSyncNet.bas (couche HTTP), modSyncParametres.bas (+4 more)
...
Cohesion: 0.20
Nodes (11): EnsureGSHeaders (X48 garde-fou en-têtes), modGraphBlocks, modSyncCfg.bas — config sync Public Const, modSyncDiag, modSyncEngine.bas (SyncCore import/export), modSyncExport, modSyncGS.bas (sync Google Sheets), modSyncNet (+3 more)
...
Cohesion: 0.29
Nodes (11): Modèle CO2 E85 vs essence (tank-to-wheel), E85_RENTABLE_RATIO, FUEL_ANY, FUEL_CONFIG, FUEL_SELECT, PRIX_API, DEFAULT_SURCONSO / DEFAULT_KIT_PRIX (aligne dashboard Excel J7/B5), prix.js (+3 more)
...
Cohesion: 0.25
Nodes (5): Job CI a11y (bloquant W81), Job CI version-check (APP_VERSION vs tag Git), .github/workflows/ci.yml — CI Lint/Tests/Version, W79 — Audit a11y axe-core WCAG A/AA, VUES
...
Cohesion: 0.50
Nodes (4): ApplyChartStyles (galerie ChartStyle), CreerGraphiquesWeb (rebuild dashboard), X64 — Styles de galerie ChartStyle, X65 — Couleurs sémantiques après ChartStyle
...
## Knowledge Gaps
- **865 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+860 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 22` to `Community 161`, `Community 162`, `Community 105`, `Community 91`, `Community 75`, `Community 44`, `Community 45`, `Community 46`, `Community 74`, `Community 148`, `Community 149`, `Community 27`, `Community 61`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 66` to `Community 33`, `Community 42`, `Community 99`, `Community 127`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `modSyncGS.bas (sync bidir.)` connect `Community 33` to `Community 66`?**
