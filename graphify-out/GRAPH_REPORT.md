...
## Corpus Check
- 4 files · ~687,836 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2425 nodes · 4112 edges · 331 communities (154 shown, 177 thin omitted)
...
- **Corpus de règles d'injection VBA via COM (vba-agent)** — tasks_lessonsmd_vba_import_vs_setmodule, tasks_lessonsmd_vba_remove_import_deferre, tasks_lessonsmd_vba_attribute_strip, tasks_lessonsmd_vba_module_state_scope, tasks_lessonsmd_vba_enableevents_restore, tasks_lessonsmd_python313_com [INFERRED 0.85]
- **Chaîne déploiement/vérif GAS Sheets (autorisation prod + OAuth API)** — tasks_miniexportfuel_g3_dashboard, tasks_lessonsmd_gas_deploy_auth, tasks_lessonsmd_sheets_api_oauth, root_packagejson_gasdeploy [INFERRED 0.75]
- **Reprise Fuel 2026-07-02 — features livrées** — roadmap_w81, roadmap_x43c_opt, roadmap_g1, roadmap_g3 [INFERRED 0.75]

## Communities (331 total, 177 thin omitted)
...
Cohesion: 0.04
Nodes (48): [2.11.0.0] — 2026-05-27, [2.12.0.0] — 2026-05-27, [2.13.0.0] — 2026-05-27, [2.14.0.0] — 2026-05-28, [2.15.0.0] — 2026-05-28, [2.17.0.0] — 2026-05-28, [2.4.5.1] — 2026-05-25, [2.8.0.0] — 2026-05-26 (+40 more)
...
Cohesion: 0.07
Nodes (37): _allRecords, buildHistoriqueCSV(), chargerHistorique(), CSV_COLS, _csvSep(), _downloadCSV(), escapeHtml(), estPleinValide() (+29 more)
...
Cohesion: 0.05
Nodes (41): [2.12.1.0] — 2026-05-27, [2.16.0.0] — 2026-05-28, [2.4.3.0] — 2026-05-25, [2.4.4.0] — 2026-05-25, [2.4.5.0] — 2026-05-25, [2.5.0.0] — 2026-05-25, [2.6.0.0] — 2026-05-25, [2.7.0.3] — 2026-05-26 (+33 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (34): OCR ticket parsing logic, Pure utility functions, cacheStationCoords(), applyTicketStation(), fillFormFromTicket(), _findStationInCommune(), FRENCH_MONTHS, FUEL_LABEL_MAP (+26 more)
...
Cohesion: 0.13
Nodes (30): Offline sync queue — localStorage queue for failed GAS POSTs, submitForm, APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), GOOGLE_CLIENT_ID (U7 auth), _getClientId(), submitForm() (+22 more)

### Community 13 - "Community 13"
Cohesion: 0.17
Nodes (30): viewchange event, _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), FUEL_CONFIG (+22 more)

### Community 14 - "Community 14"
Cohesion: 0.16
Nodes (27): Geolocation localStorage cache TTL 1h (W31), OSM brand enrichment — single Overpass grouped query to name stations, OSM enrichment (enrichStationsBulk) — background station name resolution, showMap(), Geo localStorage cache (GEO_CACHE_KEY, 1h TTL), geolocate(), loadGeoCache(), renderNearby() (+19 more)
...
Cohesion: 0.19
Nodes (17): FUEL_KEYS, updateNearbyName(), applyPricesResult(), _cget(), _ck(), _cset(), fetchPricesAtCoords(), fetchPricesByCP() (+9 more)
...
Cohesion: 0.12
Nodes (22): modSyncCfg.bas — config sync Public Const, W80 — synchronisation hors-ligne debloquee, W82 — versionnage Service Worker / feedback badge hors-ligne, Content-Security-Policy (index.html), Sync hors-ligne (offline.js, W80/W82), PWA / Service Worker (SW versionné W23/W82), Router SPA par hash (#/vue), U7 — Authentification Google (GIS multi-utilisateur) (+14 more)
...
Cohesion: 0.10
Nodes (21): G1 — listes déroulantes saisie Excel, G3 — dashboard natif Sheets, W81 — a11y WCAG AA gate bloquant, X43c-opt — rebuild ciblé rsCheap, X44 — modularisation VBA (<500 l.), commit.sh (gate Lint), APP_TOKEN (S6 token partagé), APP_VERSION (+13 more)

### Community 32 - "Community 32"
Cohesion: 0.13
Nodes (20): CHANGELOG — Suivi Conso Carburants, Axe Dev / Outillage Claude, Axe Web app, 🎯 Backend (GAS), C4 Pouvoirs navigateur Claude in Chrome, C5 Pouvoirs API Google (GAS + Sheets), 🛠️ Dev / Outillage Claude, ROADMAP — Suivi E85 (+12 more)

### Community 33 - "Community 33"
Cohesion: 0.15
Nodes (19): modGraphCfg.bas — config partagee Public + etat mPerDeb/mPerFin, modGraphData.bas — moteur d'agregats (BuildAggregates), modGraphiques.bas (dashboard graphiques), modGraphRender.bas — rendu graphiques (Add*Chart, BuildKPICards), X40 — Lint VBA pre-commit (check_vba_compile.py), X44 — Modularisation VBA (multi-phases), X61 — dates FR des abscisses du Tableau de bord, X61 — dates abscisses format FR (+11 more)
...
Cohesion: 0.15
Nodes (17): gas-config.json, Milestone v5.26.0.0 (G2 dégradé prix), _PrixHistory (relevé prix marché), Notifications push VAPID (WebPush.gs), Prix payé vs moins cher du secteur (W38), RefreshPrix.gs (relevé quotidien S8/W38), Axe Google Apps Script / Google Sheets, C1 — Skill gas-api (+9 more)
...
Cohesion: 0.40
Nodes (5): S5 — suppression d'un plein accessible utilisateur, vba/General.bas (versionné), vba/modSidebar.bas (PoserSidebarSurFeuille), vba/modSuppression.bas (frmSupprimerPlein), X40 — Lint VBA pré-commit
...
## Knowledge Gaps
- **837 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+832 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 32` to `Community 104`, `Community 42`, `Community 139`, `Community 140`, `Community 45`, `Community 43`, `Community 74`, `Community 48`, `Community 49`, `Community 93`, `Community 57`, `Community 61`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `X45 — tests unitaires VBA modTests.bas` connect `Community 60` to `Community 0`, `Community 53`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 63` to `Community 64`, `Community 121`, `Community 98`, `Community 55`?**
