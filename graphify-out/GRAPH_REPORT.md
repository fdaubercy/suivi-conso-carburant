...
## Corpus Check
- 18 files · ~703,787 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2599 nodes · 4395 edges · 344 communities (163 shown, 181 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 276 edges (avg confidence: 0.79)
...
6. `state` - 30 edges
7. `getAllRecords()` - 28 edges
8. `fetchPricesAtCoords()` - 24 edges
9. `FUEL_CONFIG` - 23 edges
10. `submitForm()` - 22 edges
...
- **Modèle de référence unifié E85 vs essence/diesel** — plans_2026_08_14_comparaison_e85_diesel_refmodel, plans_2026_08_14_comparaison_e85_diesel_buildrefmodel, plans_2026_08_14_comparaison_e85_diesel_ratioconso, plans_2026_08_14_comparaison_e85_diesel_getconsodieselref [EXTRACTED 0.90]
- **Sync P1 des clés diesel (web + Excel + GAS)** — plans_2026_08_14_comparaison_e85_diesel_parametres, plans_2026_08_14_comparaison_e85_diesel_modsyncparametres, plans_2026_08_14_comparaison_e85_diesel_gas_paramkeys, plans_2026_08_14_comparaison_e85_diesel_key_conso_diesel_ref, plans_2026_08_14_comparaison_e85_diesel_key_vehicule_diesel_ref [EXTRACTED 0.85]
...
Cohesion: 0.10
Nodes (44): viewchange event, submitForm, checkDuplicate(), clearDraft(), _getClientId(), initVoiceKm(), onKmInput(), onStationChange() (+36 more)
...
Cohesion: 0.11
Nodes (38): DOM helper functions, _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), FUEL_CONFIG (+30 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (45): carburant_ref (libellé SP98/SP95/E10), Clamp surconso [0,15 ; 0,40], COUT_TOTAL (Name dérivé), ecart_ref (écart €/L vs SP98), Postes de coût one-off (boîtier/pose/carte grise/entretien/assurance/aide), Date de rentabilité optimiste (J11), proj_nb_recents (N pleins récents), Contrainte : aucune perte de pleins (additif) (+37 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (37): OCR ticket parsing logic, Pure utility functions, detectBrand(), applyTicketStation(), fillFormFromTicket(), _findStationInCommune(), FRENCH_MONTHS, FUEL_LABEL_MAP (+29 more)
...
Cohesion: 0.11
Nodes (27): PRIX_API (data.economie.gouv.fr), cacheStationCoords(), CARTE_FUELS, computeStationAverages(), _defaultFuelForVehicle(), _ensureUserPos(), FUEL_TOKENS, _geocodeMissing() (+19 more)
...
Cohesion: 0.13
Nodes (30): C9 reporté (compte de service Google), CHANGELOG — Suivi Conso Carburants, v5.13.0.0, Artifact GAS Manager / gas-config.json, Top 5 recommandés (priorités ROADMAP), Axe Dev / Outillage Claude, Axe Web app, C11 — Cohérence FuelKeyK E10/GPLc (+22 more)

### Community 22 - "Community 22"
Cohesion: 0.11
Nodes (27): EnsureGSHeaders (X48 garde-fou en-têtes), modGraphBlocks, modSyncCfg.bas — config sync Public Const, modSyncDiag, modSyncEngine.bas (SyncCore import/export), modSyncExport, modSyncGS.bas (sync Google Sheets), modSyncJson.bas (helpers JSON/format) (+19 more)
...
Cohesion: 0.14
Nodes (26): Historical price resolution — nearest-prior sector/station price for past fills, plein-added event, APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), GOOGLE_CLIENT_ID (U7 auth), initHistoireDelete(), refreshAfterPlein() (+18 more)

### Community 25 - "Community 25"
Cohesion: 0.11
Nodes (26): Code.gs (doGet dispatcher GAS), Dashboard.gs (construireDashboard), W80 — synchronisation hors-ligne debloquee, W82 — versionnage Service Worker / feedback badge hors-ligne, Content-Security-Policy (index.html), Sync hors-ligne (offline.js, W80/W82), PWA / Service Worker (SW versionné W23/W82), Router SPA par hash (#/vue) (+18 more)
...
Cohesion: 0.18
Nodes (19): bestZoom(), hideMap(), initMapInteractions(), latLonToPx(), _renderGoogleMap(), _renderMap(), renderMiniMap(), showPinLabel() (+11 more)
...
Cohesion: 0.11
Nodes (19): buildFuelSeries(), buildPrixSparkline(), buildSparklineSVG(), _ensureMarketData(), escHtmlLocal(), FUEL_PRICE_COL, initRapport(), initRentabiliteSettings() (+11 more)

### Community 34 - "Community 34"
Cohesion: 0.15
Nodes (20): G1 — Listes déroulantes de saisie (validation données), ImporterNouveauxPleins (ModuleImportGS), RafraichirListesSaisie (modValidation), tbl_stationEssence (table Notes), tbl_vehicule (table Notes), Milestone v5.26.0.0 (G2 dégradé prix), _PrixHistory (relevé prix marché), Notifications push VAPID (WebPush.gs) (+12 more)
...
Cohesion: 0.18
Nodes (14): buildBudgetBar(), buildBudgetTrend(), buildCO2Tile(), buildMonthlyReport(), buildPrediction(), computeBudgetForecast(), _currentMonthKey(), getBudgetMensuel() (+6 more)
...
Cohesion: 0.23
Nodes (12): BuildAggregates, BuildConsoBlock, BuildPriceBlockMerged, BuildVehiculesBlock, C1 — Libellés « Super 95/98 », CreerGraphiquesWeb, G1 — Listes déroulantes de saisie, modGraphBlocks (+4 more)
...
Cohesion: 0.24
Nodes (9): clampSurconso(), computeStats(), getCoutPoste(), getCoutTotalConversion(), getEcartRef(), getKitPrix(), initKitSetting(), refShortOf() (+1 more)
...
Cohesion: 0.42
Nodes (7): buildRefModel(), computeConsoMoy(), matchType(), resolveConsoDiesel(), getCarburantRef(), getRefModelForStats(), recE85
...
Cohesion: 0.20
Nodes (6): [2.4.3.0] — 2026-05-25, [2.4.4.0] — 2026-05-25, [2.6.0.0] — 2026-05-25, Added — 🌿 Badge rentabilité E85 (ROADMAP W5), Added — PWA (W4), Added — 📈 Stats live (ROADMAP W7)
...
Cohesion: 0.47
Nodes (6): Code.gs PARAM_KEYS (whitelist GAS), clé sync conso_diesel_ref, clé sync vehicule_diesel_ref, vba/modSyncParametres.bas — transport clés, js/parametres.js — DEFS sync P1, Sync P1 last-write-wins (clés aux 3 endroits)
...
Cohesion: 0.40
Nodes (5): ApplyChartStyles (galerie ChartStyle), CreerGraphiquesWeb (rebuild dashboard), X62 — modSyncGS sous 500 lignes, X64 — Styles de galerie ChartStyle, X65 — Couleurs sémantiques après ChartStyle

### Community 119 - "Community 119"
Cohesion: 0.40
Nodes (5): js/cartealentour.js (carte alentour), Changelog Suivi E85, modFiltres.bas (filtres dashboard), v5.12.0.0 Filtres natifs du dashboard, v5.20.0.0 Carte stations moins cheres (D3)

### Community 120 - "Community 120"
Cohesion: 0.40
Nodes (5): modSuiviVehicule.bas, v5.21.0.0, X49 Carte Rentabilite kit E85, X50 Suivi Carburant reactif au vehicule, X54 Selecteur vehicule LOCAL optionnel
...
## Knowledge Gaps
- **879 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+874 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 21` to `Community 34`, `Community 69`, `Community 10`, `Community 47`, `Community 144`, `Community 156`, `Community 143`, `Community 55`, `Community 119`, `Community 120`, `Community 60`, `Community 157`, `Community 31`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 61` to `Community 125`, `Community 53`, `Community 93`, `Community 62`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `RefreshPrix.gs (relevé quotidien S8/W38)` connect `Community 34` to `Community 153`, `Community 155`, `Community 71`?**
