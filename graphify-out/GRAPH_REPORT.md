...
## Corpus Check
- 4 files · ~674,286 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2239 nodes · 3782 edges · 323 communities (147 shown, 176 thin omitted)
...
Cohesion: 0.07
Nodes (40): Repli OpenStreetMap (onFallback), brandIconUrl(), brandInfo(), BRANDS, GENERIC_BRAND_ICON, _logUnknownBrand(), _unknownSeen, _renderMap (alentour) (+32 more)
...
Cohesion: 0.07
Nodes (40): OCR ticket parsing logic, Pure utility functions, detectBrand(), applyTicketStation(), fillFormFromTicket(), _findStationInCommune(), FRENCH_MONTHS, FUEL_LABEL_MAP (+32 more)

### Community 5 - "Prix et UI carburant"
Cohesion: 0.10
Nodes (36): Flux d'authentification Google — GIS One-Tap → JWT → session localStorage, LWW parameters sync — last-write-wins reconciliation across app/Excel/GAS, auth-changed CustomEvent — émis à chaque (dé)connexion Google, authEnabled(), _avatarHtml(), _b64urlToJson(), _clearSession(), _dispatch() (+28 more)
...
Cohesion: 0.08
Nodes (36): APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), _allRecords, buildHistoriqueCSV(), chargerHistorique(), CSV_COLS, _csvSep() (+28 more)
...
Cohesion: 0.13
Nodes (31): plein-added event, submitForm, promptLogin(), checkDuplicate(), clearDraft(), _getClientId(), initVoiceKm(), onKmInput() (+23 more)
...
Cohesion: 0.10
Nodes (28): _renderLists(), rerenderHistorique(), CARTE_FUELS, computeStationAverages(), _defaultFuelForVehicle(), _ensureUserPos(), FUEL_TOKENS, _geocodeMissing() (+20 more)
...
Cohesion: 0.12
Nodes (27): Historical price resolution — nearest-prior sector/station price for past fills, refreshAfterPlein(), applyHistPriceToForm — fill form with historical price for past date (W60), applyHistPriceToForm(), _cacheKey(), escapeHtml(), _frDate(), getSectorMinForDate() (+19 more)
...
Cohesion: 0.16
Nodes (24): mountGsiButton(), initCollapsibles(), initHomeResume(), initPreferences(), initStartViewSetting(), renderHomeResume(), VIEW_META, currentView() (+16 more)
...
Cohesion: 0.18
Nodes (18): bestZoom(), hideMap(), initMapInteractions(), latLonToPx(), _renderGoogleMap(), _renderMap(), renderMiniMap(), showPinLabel() (+10 more)
...
Cohesion: 0.17
Nodes (18): modCarte.bas (cartes Excel), v5.22.0.0, v5.23.0.0, Carte alentour / stations les moins chères (cartealentour.js), Google Maps JS (cartographie), Milestone v5.23.0.0 (W82 cartes Google Maps), vba/modCarte.bas (3 cartes Excel : stations, proximité, itinéraire), Clé Maps référent-restreinte échoue en file:// (gm_authFailure) (+10 more)
...
Cohesion: 0.26
Nodes (11): viewchange event, _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), FUEL_CONFIG, _refreshVehBar(), t (+3 more)
...
## Knowledge Gaps
- **795 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+790 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Point d'entrée et stations` to `Utilitaires enseignes`, `Changelog snippets 4.3.0.5`, `Moteur de carte unifié`, `Relevé prix quotidien GAS`, `Tuiles budget et CO2`, `Skill expert VBA`, `Comparatif véhicules`, `Maquettes filtres dashboard`, `Tests prix historique`, `Débogage et tests VBA`, `Auth GAS et identité U7`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `CLAUDE.md — Instructions Claude Code` connect `Débogage et tests VBA` to `Auth et paramètres app`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `Suivi Conso Carburants — App` connect `Débogage et tests VBA` to `Emails Outlook VBA`?**
