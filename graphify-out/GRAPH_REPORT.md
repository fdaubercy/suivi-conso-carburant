...
## Corpus Check
- 4 files · ~667,519 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2080 nodes · 3531 edges · 294 communities (128 shown, 166 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 116 edges (avg confidence: 0.81)
- Token cost: 0 input · 86,027 output
...
## Communities (294 total, 166 thin omitted)

### Community 0 - "Auth et paramètres app"
Cohesion: 0.05
Nodes (67): Stats cache TTL & freshness, buildComparatifCSV(), CMP_COLS, computeVehicleComparison(), exportComparatifCSV(), initComparatifExport(), DEFAULT_SURCONSO, getAllRecords() (+59 more)
...
Cohesion: 0.07
Nodes (60): Flux d'authentification Google — GIS One-Tap → JWT → session localStorage, LWW parameters sync — last-write-wins reconciliation across app/Excel/GAS, auth-changed CustomEvent — émis à chaque (dé)connexion Google, authEnabled(), _avatarHtml(), _b64urlToJson(), _clearSession(), _dispatch() (+52 more)
...
Cohesion: 0.05
Nodes (41): [2.12.0.0] — 2026-05-27, [2.4.3.0] — 2026-05-25, [2.4.4.0] — 2026-05-25, [2.4.5.0] — 2026-05-25, [2.5.0.0] — 2026-05-25, [2.6.0.0] — 2026-05-25, [2.7.0.3] — 2026-05-26, [2.9.0.0] — 2026-05-26 (+33 more)
...
Cohesion: 0.09
Nodes (33): _close(), GMAPS_URL(), _onKey(), showStationPopup(), WAZE_URL(), CARTE_FUELS, computeStationAverages(), _defaultFuelForVehicle() (+25 more)
...
Cohesion: 0.10
Nodes (31): Historical price resolution — nearest-prior sector/station price for past fills, APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), initHistoireDelete(), applyHistPriceToForm — fill form with historical price for past date (W60), applyHistPriceToForm(), _cacheKey() (+23 more)

### Community 11 - "Prix secteur historique"
Cohesion: 0.13
Nodes (31): Offline sync queue — localStorage queue for failed GAS POSTs, submitForm, getIdToken(), _getClientId(), submitForm(), clearFromQueue(), getPendingCount(), getQueue() (+23 more)
...
Cohesion: 0.20
Nodes (27): DOM helper functions, _buildTypeToggle(), _updateHeaderBadges(), clearDraft(), onStationChange(), resetForm(), applyPricesResult(), _cget() (+19 more)
...
Cohesion: 0.16
Nodes (26): viewchange event, checkDuplicate(), initVoiceKm(), onKmInput(), restoreDraft(), saveDraft(), getMaxKmForVehicule(), initStaticHandlers() (+18 more)
...
Cohesion: 0.10
Nodes (25): modSyncGS.bas (sync Google Sheets), C4 Pouvoirs navigateur Claude in Chrome, C5 Pouvoirs API Google (GAS + Sheets), C6 Renouvellement automatique token OAuth, ROADMAP C9 — Service account Google, G1 Validation de donnees onglet saisie GS, G2 MFC prix sur le Sheet, G3 Onglet Dashboard natif Sheets (+17 more)
...
Cohesion: 0.21
Nodes (17): OSM brand enrichment — single Overpass grouped query to name stations, showMap(), enrichStationsBulk(), buildSearchClause(), buildStations(), geocodeAddress(), onAutreInput(), searchStationsCityOnly() (+9 more)
...
Cohesion: 0.18
Nodes (10): _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), Constantes CO2 (W40/W51), FUEL_CONFIG, GAS_ERROR, GAS_SUCCESS (+2 more)
...
Cohesion: 0.24
Nodes (11): Rapport d'avancée par étape (AVANCEMENT-<id>.md), Règles VBA Suivi Conso Carburants, Skill vba-agent (COM/pywin32), Plan MAJ d'ouverture en arrière-plan (#6), AVANCEMENT #6 (v5.19.0.0), Double Option Explicit à l'injection COM, Formula2 pour formules array structured refs (Excel 365), Garde anti-amputation graphify (#37/#44) (+3 more)
...
Cohesion: 0.20
Nodes (10): js/cartealentour.js (carte alentour), Changelog Suivi E85, modFiltres.bas (filtres dashboard), CHANGELOG v5.13.0.0, v5.12.0.0 Filtres natifs du dashboard, v5.20.0.0 Carte stations moins cheres (D3), Lesson: never CStr() a real date for re-parsing, Lesson: timeline SetFilterDateRange ignores fractional dates (+2 more)

### Community 62 - "Débogage et tests VBA"
Cohesion: 0.20
Nodes (10): MapEngineJs (moteur carte unifie), modCarte.bas (cartes Excel), GOOGLE_MAPS_API_KEY, GOOGLE_MAPS_MAP_ID (Advanced markers), W82 Cartes Excel en Google Maps, X57 Cartes proximite + itineraire Excel, X59 Marqueurs cartes avec logo d'enseigne, modCarte (cartes Excel) (+2 more)
...
Cohesion: 0.22
Nodes (9): ThisWorkbook.cls (Workbook_Open), Drapeau gSilentOpen (Approche A), modDashboardGraphiques.bas (MAJ_Dashboard_Graphiques), modWorkbook.bas, RunSilentTask + OpenTask_* wrappers, Incident hang COM (modWorkbook vidé), X60 Ecran d'attente au demarrage (splash), Design MAJ ouverture arrière-plan, Accueil figé (+1 more)
...
Cohesion: 0.25
Nodes (8): carte.js (rendu carte), formulaire.js (soumission plein), geo.js (géoloc + stations proches), osm.js (enrichissement Overpass), D1 refreshAfterPlein (hub MAJ post-plein), D3 carte stations alentour (top 3), Design 3 fonctionnalités app (flexfuel), Reprise 2026-06-18 (flexfuel)
...
Cohesion: 0.29
Nodes (7): GS_Pleins (table Power Query), modGraphiques.bas (dashboard graphiques), _PrixHistory / PrixHistory (prix marche), ROADMAP X39 — Accumulation prix marché, X47 Economies E85/CO2 negatives sans prix SP98 ref, X48 Garde-fou en-tetes GS_Pleins, X49 Carte Rentabilite kit E85

### Community 82 - "Power Query import GS"
Cohesion: 0.29
Nodes (7): modSuiviVehicule.bas, Last-write-wins par clé (paramètres), Onglet Parametres (source unique métier P1), X50 Suivi Carburant reactif au vehicule, X51 Projection rentabilite kit filtree par vehicule, X54 Selecteur vehicule LOCAL optionnel, modSyncParametres.bas (sync params P1)
...
Cohesion: 0.33
Nodes (6): historique.js, Cellule paramètre désalignée (vérifier libellé réel), commit ≠ push (jamais pousser sans accord), Carte Rentabilité kit E85 + fix surconso J7→J8, Bug plein 01/01/1970 (ligne fantôme _ImportGS), Reprise 2026-06-23 (fuel)
...
Cohesion: 0.50
Nodes (4): secteur.js (prix mini secteur), stats.js (KPIs, sparkline), statsApi.js (agrégats GAS), D2 buildPrixSparkline (marché + mes pleins)
...
## Knowledge Gaps
- **769 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+764 more)
...
- **Why does `CLAUDE.md — Instructions Claude Code` connect `Leçons VBA apprises` to `Changelog versions 2-3`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `Suivi Conso Carburants — App` connect `Leçons VBA apprises` to `Tests end-to-end`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `Roadmap Suivi E85` connect `Reconstruction VBA sidebar` to `Installation agent VBA`, `Changelog version 5`, `README agent VBA`, `Changelog audit classeur`, `Power Query import GS`, `Leçons VBA apprises`, `Config correcteur ortho`, `Script boutons PowerShell`, `Tests prix historique`, `Débogage et tests VBA`?**
