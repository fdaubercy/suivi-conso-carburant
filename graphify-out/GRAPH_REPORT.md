...
## Corpus Check
- 4 files · ~685,568 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2369 nodes · 4041 edges · 322 communities (146 shown, 176 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 207 edges (avg confidence: 0.78)
...
- **X44 — découpe monolithe modGraphiques** — changelog_modgraphiques, changelog_modgraphcfg, changelog_modgraphdata, changelog_modgraphrender [EXTRACTED 1.00]
- **X45 — modTests couvre fonctions pures VBA** — changelog_x45_modtests, changelog_moddashboardkpi, changelog_modgraphdata [INFERRED 0.75]

## Communities (322 total, 176 thin omitted)
...
Cohesion: 0.06
Nodes (62): Flux d'authentification Google — GIS One-Tap → JWT → session localStorage, LWW parameters sync — last-write-wins reconciliation across app/Excel/GAS, auth-changed CustomEvent — émis à chaque (dé)connexion Google, authEnabled(), _avatarHtml(), _b64urlToJson(), _clearSession(), _dispatch() (+54 more)
...
Cohesion: 0.07
Nodes (43): Violation a11y color-contrast (sérieux), Violation a11y select-name (#stationSel, critique), @axe-core/playwright (devDep), CHANGELOG 5.27.0.0 — X41 + X51, ClassifyFilterDelta (rsNone/rsTargeted/rsFull), modFiltres.DebouncedRebuild, Cellule _GraphData!ZZ1 (stockage signature), Empreinte des données source (SourceFingerprint Tableau2/GS_Pleins) (+35 more)
...
Cohesion: 0.07
Nodes (41): MapEngineJs (moteur carte unifie), modCarte.bas (cartes Excel), v5.22.0.0, v5.23.0.0, Carte alentour / stations les moins chères (cartealentour.js), Google Maps JS (cartographie), Milestone v5.23.0.0 (W82 cartes Google Maps), vba/modCarte.bas (3 cartes Excel : stations, proximité, itinéraire) (+33 more)

### Community 9 - "Notifications et badges"
Cohesion: 0.17
Nodes (33): _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), FUEL_CONFIG, FUEL_KEYS (+25 more)

### Community 10 - "Historique des pleins"
Cohesion: 0.08
Nodes (37): Badge hors-ligne cliquable (W80), _lastSyncAttemptTs (garde 30s), Synchronisation hors-ligne débloquée (W80), CHANGELOG v5.29.0.1 (2026-06-30), Version 5.30.0.0, W78 — Lazy-load carte / Google Maps, BAN_API, GOOGLE_MAPS_API_KEY (+29 more)
...
Cohesion: 0.12
Nodes (27): Historical price resolution — nearest-prior sector/station price for past fills, plein-added event, refreshAfterPlein(), applyHistPriceToForm(), _cacheKey(), escapeHtml(), _frDate(), getSectorMinForDate() (+19 more)

### Community 17 - "Formulaire de saisie"
Cohesion: 0.11
Nodes (25): viewchange event, checkDuplicate(), initVoiceKm(), onKmInput(), restoreDraft(), saveDraft(), getMaxKmForVehicule(), _refreshVehBar() (+17 more)

### Community 18 - "Backend GAS multi-carburant"
Cohesion: 0.10
Nodes (26): PRIX_API (data.economie.gouv.fr), CARTE_FUELS, computeStationAverages(), _defaultFuelForVehicle(), _ensureUserPos(), FUEL_TOKENS, _geocodeMissing(), _geocodeTried (+18 more)
...
Cohesion: 0.10
Nodes (25): CHANGELOG — Suivi Conso Carburants, modSuiviVehicule.bas, v5.21.0.0, Axe Dev / Outillage Claude, Axe Web app, 🎯 Backend (GAS), C4 Pouvoirs navigateur Claude in Chrome, C5 Pouvoirs API Google (GAS + Sheets) (+17 more)
...
Cohesion: 0.15
Nodes (21): Geolocation localStorage cache TTL 1h (W31), OSM enrichment (enrichStationsBulk) — background station name resolution, Geo localStorage cache (GEO_CACHE_KEY, 1h TTL), geolocate(), highlightNearbyItem(), initNearbyList(), loadGeoCache(), pickStation() (+13 more)

### Community 25 - "Rendu Google Maps stations"
Cohesion: 0.09
Nodes (25): localStorage Keys, initVoiceKm, onKmInput, onStationChange, restoreDraft, saveDraft, initStaticHandlers, main.js (+17 more)
...
Cohesion: 0.22
Nodes (20): Offline sync queue — localStorage queue for failed GAS POSTs, submitForm, APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), _getClientId(), submitForm(), initHistoireDelete() (+12 more)

### Community 32 - "Sous-commandes agent VBA"
Cohesion: 0.16
Nodes (19): modGraphCfg.bas — config partagee Public + etat mPerDeb/mPerFin, modGraphData.bas — moteur d'agregats (BuildAggregates), modGraphiques.bas (dashboard graphiques), modGraphRender.bas — rendu graphiques (Add*Chart, BuildKPICards), modSyncCfg.bas — config sync Public Const, X40 — Lint VBA pre-commit (check_vba_compile.py), X44 — Modularisation VBA (multi-phases), X44 — modularisation VBA gros modules (+11 more)

### Community 33 - "Utilitaires enseignes"
Cohesion: 0.12
Nodes (16): OCR ticket parsing logic, FRENCH_MONTHS, FUEL_LABEL_MAP, initScanner(), normalizeNumericText(), parseOCRText(), scanWithGemini(), toFloat() (+8 more)

### Community 34 - "Plan filtres dashboard"
Cohesion: 0.15
Nodes (18): Pure utility functions, detectBrand(), _findStationInCommune(), brandFromAddress(), composeStationName(), formatVille(), resolveEnseigne(), stationLabel() (+10 more)
...
Cohesion: 0.17
Nodes (18): Feuil3 (Tableau de bord), Milestone v5.13.0.0 (X43 rebuild non bloquant), modDashboardGraphiques, modFiltres, ThisWorkbook, ApplyFiltersFromControls, BuildConsoBlock (gConso multi-vehicule), BuildPriceBlockMerged (gPrice multi-carburant) (+10 more)
...
Cohesion: 0.15
Nodes (13): DOM helper functions, calcTriplet(), setSubmitState(), emptyResp(), makeResp(), priceResp(), describe: computeTriplet — wiring DOM, describe: showCpSearch / hideCpSearch (+5 more)

### Community 43 - "Reprises de session"
Cohesion: 0.30
Nodes (15): OSM brand enrichment — single Overpass grouped query to name stations, showMap(), renderNearby(), enrichStationsBulk(), buildSearchClause(), buildStations(), geocodeAddress(), onAutreInput() (+7 more)
...
Cohesion: 0.21
Nodes (14): W80 — synchronisation hors-ligne debloquee, W82 — versionnage Service Worker / feedback badge hors-ligne, config.js (Configuration globale), APP_TOKEN, APP_VERSION, GAS_URL, Authentification Google U7 (GOOGLE_CLIENT_ID, GIS), GOOGLE_CLIENT_ID (+6 more)
...
Cohesion: 0.41
Nodes (12): initStaticHandlers(), setVehiculeStatus(), _autoSelectLastVehicule(), chargerVehicules(), confirmerAjoutVehicule(), getVehicules(), onVehiculeChange(), _populateGlobalVehiculeSelect() (+4 more)
...
Cohesion: 0.38
Nodes (7): modDashboardKPI.bas (ConsoL100, ComputeDashboardStats), X45 — tests unitaires VBA modTests.bas, X53 — nettoyage code mort éco E85 (v5.30.6.0), CO2 Constants, DEFAULT_SURCONSO, computeSurconso, stats.js
...
Cohesion: 0.29
Nodes (7): Tableau de bord Excel, Filtres natifs dashboard (segments véhicule/carburant + chronologie), GS_Pleins (table Power Query), Carte Rentabilité kit E85, Suivi véhicule (modSuiviVehicule.bas, multi-véhicule), ROADMAP X45 — Tests VBA fonctions pures, X51 Projection rentabilite kit filtree par vehicule
...
Cohesion: 0.33
Nodes (6): commit.sh (gate Lint), Règle : retirer Attribute VB_Name avant set-module, Règle : Const mal placée = erreur compile-on-demand, Règle : garde anti-amputation graphify --update, tasks/lessons.md — Lessons Learned, scripts/check_vba_compile.py
...
Cohesion: 0.67
Nodes (3): S5 — suppression d'un plein accessible utilisateur, vba/modSidebar.bas (PoserSidebarSurFeuille), vba/modSuppression.bas (frmSupprimerPlein)
...
## Knowledge Gaps
- **823 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+818 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Reconstruction VBA sidebar` to `Sous-commandes agent VBA`, `Service Worker et PWA`, `Changelog snippets 4.3.0.5`, `Changelog déploiement 5.0`, `Carte itinéraire`, `PWA et instructions Claude`, `Découvrabilité boutons-icônes`, `Rendu carte et tuiles`, `Backend GAS et scan IA`, `Sync bidirectionnelle Excel-GS`, `Splash démarrage Excel`, `Données externes VBA`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Pull-to-refresh` to `Avancement filtres X39`, `Design fonctionnalités flexfuel`, `Config carburants et API`, `Charte et workflow UI`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `RefreshPrix.gs (relevé quotidien S8/W38)` connect `Backend GAS et scan IA` to `API route OSRM`, `Moteur de carte unifié`, `Architecture générale`?**
