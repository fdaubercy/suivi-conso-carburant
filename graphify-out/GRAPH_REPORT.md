...
## Corpus Check
- 6 files · ~687,074 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2402 nodes · 4089 edges · 324 communities (149 shown, 175 thin omitted)
- Extraction: 94% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 224 edges (avg confidence: 0.78)
...
- **Intégration app web ↔ Google Apps Script** — js_config_gasurl, js_config_apptoken, js_config_googleclientid, js_config_gssheetid [INFERRED 0.75]
- **Features livrées reprise Fuel v5.30.8→11** — changelog_w81_a11y, changelog_x43copt_rscheap, changelog_g1_dropdowns, changelog_g3_dashboard [EXTRACTED 1.00]
- **Gates qualité VBA** — changelog_x40_lint_vba, changelog_x45_tests_vba, changelog_x44_modularisation [INFERRED 0.75]

## Communities (324 total, 175 thin omitted)
...
Cohesion: 0.04
Nodes (48): [2.12.1.0] — 2026-05-27, [2.13.0.0] — 2026-05-27, [2.14.0.0] — 2026-05-28, [2.15.0.0] — 2026-05-28, [2.4.5.0] — 2026-05-25, [2.4.5.1] — 2026-05-25, [2.8.0.0] — 2026-05-26, [2.9.0.0] — 2026-05-26 (+40 more)
...
Cohesion: 0.06
Nodes (37): OCR ticket parsing logic, calculerStatsRapport(), construireUrlGraphePrix(), FRENCH_MONTHS, FUEL_LABEL_MAP, initScanner(), normalizeNumericText(), parseOCRText() (+29 more)
...
Cohesion: 0.05
Nodes (41): [2.11.0.0] — 2026-05-27, [2.12.0.0] — 2026-05-27, [2.16.0.0] — 2026-05-28, [2.17.0.0] — 2026-05-28, [2.4.3.0] — 2026-05-25, [2.4.4.0] — 2026-05-25, [2.5.0.0] — 2026-05-25, [2.6.0.0] — 2026-05-25 (+33 more)
...
Cohesion: 0.10
Nodes (30): buildBudgetBar(), buildBudgetTrend(), buildCO2Tile(), buildFuelSeries(), buildMonthlyReport(), buildPrixSparkline(), buildSparklineSVG(), computeBudgetForecast() (+22 more)
...
Cohesion: 0.10
Nodes (28): PRIX_API (data.economie.gouv.fr), cacheStationCoords(), CARTE_FUELS, computeStationAverages(), _defaultFuelForVehicle(), _ensureUserPos(), FUEL_TOKENS, _geocodeMissing() (+20 more)
...
Cohesion: 0.14
Nodes (21): modGraphCfg.bas — config partagee Public + etat mPerDeb/mPerFin, modGraphData.bas — moteur d'agregats (BuildAggregates), modGraphiques.bas (dashboard graphiques), modGraphRender.bas — rendu graphiques (Add*Chart, BuildKPICards), S5 — suppression d'un plein accessible utilisateur, X44 — Modularisation VBA (multi-phases), X61 — dates FR des abscisses du Tableau de bord, X61 — dates abscisses format FR (+13 more)
...
Cohesion: 0.13
Nodes (21): modSyncCfg.bas — config sync Public Const, W80 — synchronisation hors-ligne debloquee, W82 — versionnage Service Worker / feedback badge hors-ligne, Content-Security-Policy (index.html), Sync hors-ligne (offline.js, W80/W82), PWA / Service Worker (SW versionné W23/W82), Router SPA par hash (#/vue), U7 — Authentification Google (GIS multi-utilisateur) (+13 more)
...
Cohesion: 0.24
Nodes (17): viewchange event, _refreshVehBar(), t, applyTheme(), initTheme(), toggleTheme(), setVehiculeStatus(), _autoSelectLastVehicule() (+9 more)
...
Cohesion: 0.13
Nodes (15): CLAUDE.md — Instructions Claude Code, Docs de référence (docs/ARCHITECTURE…), Gate pré-commit /graphify --update, Langue de travail français obligatoire, Self-learning tasks/lessons.md, Versioning X.Y.Z.W + Conventional Commits, dismiss(), _hide() (+7 more)
...
Cohesion: 0.26
Nodes (15): Offline sync queue — localStorage queue for failed GAS POSTs, APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), GOOGLE_CLIENT_ID (U7 auth), initHistoireDelete(), clearFromQueue(), getPendingCount() (+7 more)
...
Cohesion: 0.31
Nodes (7): _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), FUEL_CONFIG, FUEL_KEYS, state
...
Cohesion: 0.20
Nodes (10): devDependencies, eslint, @eslint/js, husky, jsdom, vite, vitest, @vitest/coverage-v8 (+2 more)
...
Cohesion: 0.39
Nodes (7): _close(), GMAPS_URL(), _onKey(), showStationPopup(), WAZE_URL(), escHtml(), BASE
...
## Knowledge Gaps
- **833 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+828 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 34` to `Community 98`, `Community 133`, `Community 134`, `Community 72`, `Community 73`, `Community 46`, `Community 47`, `Community 81`, `Community 52`, `Community 89`, `Community 27`, `Community 62`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `X45 — tests unitaires VBA modTests.bas` connect `Community 12` to `Community 0`, `Community 49`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 65` to `Community 116`, `Community 4`, `Community 60`, `Community 93`?**
