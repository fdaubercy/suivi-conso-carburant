...
## Corpus Check
- 6 files · ~677,856 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2265 nodes · 3831 edges · 322 communities (146 shown, 176 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 162 edges (avg confidence: 0.79)
...
- **Flux sync manuelle avec reconnexion (clic badge → promptLogin → auth-changed → syncQueue)** — specs_2026_06_29_sync_hors_ligne_deblocage_design_offlinebadge, specs_2026_06_29_sync_hors_ligne_deblocage_design_syncqueue, specs_2026_06_29_sync_hors_ligne_deblocage_design_promptlogin, specs_2026_06_29_sync_hors_ligne_deblocage_design_auth_changed_event [EXTRACTED 0.95]
- **Déclencheurs de sync auto sur mobile (online, visibilitychange, Background Sync)** — specs_2026_06_29_sync_hors_ligne_deblocage_design_online_event, specs_2026_06_29_sync_hors_ligne_deblocage_design_visibilitychange, specs_2026_06_29_sync_hors_ligne_deblocage_design_background_sync, specs_2026_06_29_sync_hors_ligne_deblocage_design_syncqueue [EXTRACTED 0.90]
- **Livrable W80 (plan + spec + changelog + roadmap suite W82)** — plans_2026_06_29_sync_hors_ligne_deblocage_plan, specs_2026_06_29_sync_hors_ligne_deblocage_design_spec, changelog_v5_29_0_1, roadmap_w82_anti_rebond_visibilitychange [INFERRED 0.85]
...
Cohesion: 0.04
Nodes (48): [2.11.0.0] — 2026-05-27, [2.12.1.0] — 2026-05-27, [2.13.0.0] — 2026-05-27, [2.14.0.0] — 2026-05-28, [2.16.0.0] — 2026-05-28, [2.17.0.0] — 2026-05-28, [2.4.5.1] — 2026-05-25, [2.5.0.0] — 2026-05-25 (+40 more)
...
Cohesion: 0.10
Nodes (41): viewchange event, submitForm, checkDuplicate(), clearDraft(), _getClientId(), initVoiceKm(), onKmInput(), resetForm() (+33 more)
...
Cohesion: 0.05
Nodes (41): [2.12.0.0] — 2026-05-27, [2.15.0.0] — 2026-05-28, [2.4.3.0] — 2026-05-25, [2.4.4.0] — 2026-05-25, [2.4.5.0] — 2026-05-25, [2.6.0.0] — 2026-05-25, [2.7.0.3] — 2026-05-26, [2.9.0.0] — 2026-05-26 (+33 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (34): Flux d'authentification Google — GIS One-Tap → JWT → session localStorage, LWW parameters sync — last-write-wins reconciliation across app/Excel/GAS, auth-changed CustomEvent — émis à chaque (dé)connexion Google, authEnabled(), _avatarHtml(), _b64urlToJson(), _clearSession(), _dispatch() (+26 more)
...
Cohesion: 0.10
Nodes (31): Repli OpenStreetMap (onFallback), _renderMap (alentour), AL_FUELS, _card(), _distLabel(), _ensurePosition(), _fetchStations(), _fuel (+23 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (33): _priceBadge(), _close(), GMAPS_URL(), _onKey(), showStationPopup(), WAZE_URL(), cacheStationCoords(), CARTE_FUELS (+25 more)
...
Cohesion: 0.14
Nodes (31): Geolocation localStorage cache TTL 1h (W31), OSM brand enrichment — single Overpass grouped query to name stations, OSM enrichment (enrichStationsBulk) — background station name resolution, showMap(), FUEL_CONFIG, Geo localStorage cache (GEO_CACHE_KEY, 1h TTL), geolocate(), highlightNearbyItem() (+23 more)
...
Cohesion: 0.19
Nodes (26): _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), onStationChange(), pickStation() (+18 more)
...
Cohesion: 0.16
Nodes (22): Badge hors-ligne cliquable (W80), Synchronisation hors-ligne débloquée (W80), CHANGELOG v5.29.0.1 (2026-06-30), superpowers:executing-plans, Livraison (commit final groupé — gate Graphify), tests/offline.test.js (17 tests), Plan: Déblocage & fiabilisation de la sync hors-ligne, superpowers:subagent-driven-development (+14 more)
...
Cohesion: 0.11
Nodes (20): GS_Pleins (table Power Query), modGraphiques.bas (dashboard graphiques), modSuiviVehicule.bas, _PrixHistory / PrixHistory (prix marche), v5.20.0.0, v5.21.0.0, Empreinte CO2 E85 vs essence, GS_Pleins (table Power Query) (+12 more)
...
Cohesion: 0.40
Nodes (5): Graphique gPrice (évolution prix marché), Power Query PrixHistory.m, Onglet _PrixHistory (relevés marché), modFiltres.bas (segments/chronologie X43), modGraphiques.bas (Tableau de bord, gPrice…)
...
## Knowledge Gaps
- **801 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+796 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Community 36` to `Community 129`, `Community 130`, `Community 37`, `Community 70`, `Community 46`, `Community 83`, `Community 30`, `Community 89`, `Community 59`, `Community 60`, `Community 61`, `Community 62`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `CLAUDE.md — Instructions Claude Code` connect `Community 61` to `Community 0`, `Community 14`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `Suivi Conso Carburants — App` connect `Community 14` to `Community 61`?**
