...
## Corpus Check
- 7 files · ~685,815 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2382 nodes · 4070 edges · 327 communities (154 shown, 173 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 215 edges (avg confidence: 0.78)
...
- **Gate a11y bloquant (W79→W81)** — tests_a11y_spec, ci_job_a11y, concept_a11y_gate, concept_w79_a11y_audit [EXTRACTED 0.90]
- **APP_VERSION source de vérité (config→package→CI)** — config_app_version, package, ci_job_version_check [INFERRED 0.85]
- **Shell PWA/SPA (index, router, SW, offline)** — index_html, concept_spa_router, concept_pwa_sw, concept_offline_queue [INFERRED 0.85]

## Communities (327 total, 173 thin omitted)
...
Cohesion: 0.10
Nodes (37): viewchange event, submitForm, checkDuplicate(), _getClientId(), initVoiceKm(), onKmInput(), restoreDraft(), saveDraft() (+29 more)
...
Cohesion: 0.10
Nodes (30): _allRecords, buildHistoriqueCSV(), chargerHistorique(), CSV_COLS, _csvSep(), escapeHtml(), estPleinValide(), _filteredRecords() (+22 more)
...
Cohesion: 0.19
Nodes (13): modDashboardKPI.bas (ConsoL100, ComputeDashboardStats), X45 — tests unitaires VBA modTests.bas, X53 — nettoyage code mort éco E85 (v5.30.6.0), CO2 Constants, DEFAULT_SURCONSO, localStorage Keys, formulaire.js, saveDraft (+5 more)
...
Cohesion: 0.31
Nodes (7): _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), FUEL_CONFIG, state, BASE
...
Cohesion: 0.30
Nodes (11): modGraphCfg.bas — config partagee Public + etat mPerDeb/mPerFin, modGraphData.bas — moteur d'agregats (BuildAggregates), modGraphiques.bas (dashboard graphiques), modGraphRender.bas — rendu graphiques (Add*Chart, BuildKPICards), X44 — Modularisation VBA (multi-phases), X61 — dates FR des abscisses du Tableau de bord, X61 — dates abscisses format FR, X44 — Modularisation gros modules VBA (< 500 l.) (+3 more)
...
Cohesion: 0.43
Nodes (7): _priceBadge(), _close(), GMAPS_URL(), _onKey(), showStationPopup(), WAZE_URL(), escHtml()
...
- **Why does `ROADMAP — Suivi E85` connect `Community 22` to `Community 69`, `Community 102`, `Community 39`, `Community 41`, `Community 138`, `Community 137`, `Community 48`, `Community 82`, `Community 83`, `Community 52`, `Community 53`, `Community 30`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `X45 — tests unitaires VBA modTests.bas` connect `Community 51` to `Community 72`, `Community 1`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `Synchronisation bidirectionnelle Excel ↔ GS` connect `Community 55` to `Community 46`, `Community 58`, `Community 94`, `Community 119`?**
