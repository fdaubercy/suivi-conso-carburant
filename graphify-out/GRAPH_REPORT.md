...
## Corpus Check
- 4 files · ~682,517 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2318 nodes · 3917 edges · 325 communities (150 shown, 175 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 168 edges (avg confidence: 0.79)
...
- `Rentabilité kit E85 (éco cumulée / coût kit, surconso J8)` --conceptually_related_to--> `Seuil de rentabilité E85 vs SP98 (ratio 0.66 / surconso)`  [INFERRED]
  ROADMAP.md → js/config.js

## Import Cycles
- None detected.

## Communities (325 total, 175 thin omitted)
...
Cohesion: 0.07
Nodes (59): Flux d'authentification Google — GIS One-Tap → JWT → session localStorage, LWW parameters sync — last-write-wins reconciliation across app/Excel/GAS, Offline sync queue — localStorage queue for failed GAS POSTs, auth-changed CustomEvent — émis à chaque (dé)connexion Google, authEnabled(), _avatarHtml(), _b64urlToJson(), _clearSession() (+51 more)
...
Cohesion: 0.04
Nodes (48): [2.12.0.0] — 2026-05-27, [2.12.1.0] — 2026-05-27, [2.13.0.0] — 2026-05-27, [2.14.0.0] — 2026-05-28, [2.15.0.0] — 2026-05-28, [2.16.0.0] — 2026-05-28, [2.17.0.0] — 2026-05-28, [2.4.5.1] — 2026-05-25 (+40 more)
...
Cohesion: 0.06
Nodes (47): Badge hors-ligne cliquable (W80), _lastSyncAttemptTs (garde 30s), S5 — suppression d'un plein accessible utilisateur, Synchronisation hors-ligne débloquée (W80), CHANGELOG v5.29.0.1 (2026-06-30), Version 5.30.0.0, W78 — Lazy-load carte / Google Maps, X40 — Lint VBA pré-commit (+39 more)
...
Cohesion: 0.12
Nodes (34): submitForm, FUEL_KEYS, checkDuplicate(), clearDraft(), _getClientId(), initVoiceKm(), onKmInput(), resetForm() (+26 more)

### Community 8 - "Découvrabilité boutons-icônes"
Cohesion: 0.05
Nodes (41): [2.11.0.0] — 2026-05-27, [2.4.3.0] — 2026-05-25, [2.4.4.0] — 2026-05-25, [2.4.5.0] — 2026-05-25, [2.5.0.0] — 2026-05-25, [2.6.0.0] — 2026-05-25, [2.7.0.3] — 2026-05-26, [2.9.0.0] — 2026-05-26 (+33 more)
...
Cohesion: 0.09
Nodes (35): _allRecords, buildHistoriqueCSV(), chargerHistorique(), CSV_COLS, _csvSep(), _downloadCSV(), dupliquerDernier(), escapeHtml() (+27 more)
...
Cohesion: 0.13
Nodes (31): DOM helper functions, _buildTypeToggle(), _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), _updateHeaderBadges(), FUEL_CONFIG (+23 more)
...
Cohesion: 0.15
Nodes (24): Historical price resolution — nearest-prior sector/station price for past fills, plein-added event, APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), initHistoireDelete(), refreshAfterPlein(), applyHistPriceToForm() (+16 more)
...
Cohesion: 0.13
Nodes (18): CHANGELOG — Suivi Conso Carburants, Axe Web app, 🛠️ Dev / Outillage Claude, ROADMAP — Suivi E85, 📊 Excel, ✅ Idées déjà implémentées, 🎯 Onglet "Tableau de bord", ⚡ Performance (+10 more)
...
Cohesion: 0.14
Nodes (16): GS_Pleins (table Power Query), modGraphiques.bas (dashboard graphiques), modSuiviVehicule.bas, _PrixHistory / PrixHistory (prix marche), v5.20.0.0, v5.21.0.0, GS_Pleins (table Power Query), Suivi véhicule (modSuiviVehicule.bas, multi-véhicule) (+8 more)
...
Cohesion: 0.15
Nodes (15): calculerStatsRapport(), construireUrlGraphePrix(), APP_TOKEN (token endpoints GAS S6), Code.gs (backend GAS), Google Sheet (stockage données), Table GS_Pleins (Excel), Onglet _ImportGS (16+ colonnes), Power Query GS_Pleins.m (+7 more)
...
Cohesion: 0.23
Nodes (11): viewchange event, _refreshVehBar(), t, chargerStations(), _gsStations, _historyStations, mergeHistoryStations(), _renderStationOptions() (+3 more)

### Community 46 - "Sync bidirectionnelle Excel-GS"
Cohesion: 0.23
Nodes (9): buildComparatifCSV(), CMP_COLS, computeVehicleComparison(), exportComparatifCSV(), initComparatifExport(), getAllRecords(), _computePrediction(), getNextKmPrediction() (+1 more)
...
Cohesion: 0.27
Nodes (10): Repli OpenStreetMap (onFallback), googleMapsEnabled(), loadClusterer(), loadGoogleMaps(), _attach(), _inst, renderGoogleStationMap(), _userDotEl() (+2 more)
...
Cohesion: 0.25
Nodes (8): modSyncGS.bas (sync Google Sheets), v5.25.0.0, Milestone v5.25.0.0 (X46 santé sync), modSyncGS.bas (sync Excel↔GS), _SyncLog (journal de synchro), Axe Synchronisation Excel <-> Google Sheets, S3/S4/S5 — Suppression bidir., force resync, conflits timestamp, X46 Sante de la sync dans Reglages
...
## Knowledge Gaps
- **813 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+808 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Utilitaires enseignes` to `Changelog snippets 4.3.0.5`, `Moteur de carte unifié`, `Installation et mise à jour`, `Relevé prix quotidien GAS`, `Tuiles budget et CO2`, `Icône bouton Graphiques`, `Manifeste PWA`, `Reprises et avancement`, `Avancement ouverture arrière-plan`, `Débogage et tests VBA`, `Gestion fichiers VBA`, `Cartes Excel Google Maps`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `CLAUDE.md — Instructions Claude Code` connect `Cartes Excel Google Maps` to `Auth et paramètres app`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `Suivi Conso Carburants — App` connect `Cartes Excel Google Maps` to `Emails Outlook VBA`?**
