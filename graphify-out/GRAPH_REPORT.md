...
## Corpus Check
- 5 files · ~672,899 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2210 nodes · 3745 edges · 306 communities (132 shown, 174 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 154 edges (avg confidence: 0.79)
...
## Communities (306 total, 174 thin omitted)

### Community 0 - "Auth et paramètres app"
Cohesion: 0.06
Nodes (71): Flux d'authentification Google — GIS One-Tap → JWT → session localStorage, LWW parameters sync — last-write-wins reconciliation across app/Excel/GAS, auth-changed CustomEvent — émis à chaque (dé)connexion Google, authEnabled(), _avatarHtml(), _b64urlToJson(), _clearSession(), _dispatch() (+63 more)
...
Cohesion: 0.06
Nodes (62): Stats cache TTL & freshness, Constantes CO2 (W40/W51), DEFAULT_SURCONSO, forceRefreshHistorique(), buildBudgetBar(), buildBudgetTrend(), buildCo2Annuel(), buildCo2Monthly() (+54 more)

### Community 3 - "Déploiement GAS"
Cohesion: 0.06
Nodes (40): CHANGELOG v5.14.0.0, Empreinte CO2 E85 vs essence, Milestone v3.6.0.0 (S6 token + W37 Wrapped + W38), Bilan annuel Wrapped (wrapped.js), 0. 🚀 GO ! — Installation en un clic, 1.1 Prérequis (une seule fois), 1.2 Modules standards à (ré)importer, 1.3 Module de feuille (+32 more)
...
Cohesion: 0.07
Nodes (42): CHANGELOG 5.27.0.0 — X41 + X51, ClassifyFilterDelta (rsNone/rsTargeted/rsFull), ComputeRebuildSignature(), CreerGraphiquesWeb (chemin rebuild complet), DebouncedRebuild, DeverrouillerSuivi / VerrouillerSuivi (feuille protégée), Feuil3 (Tableau de bord), ImporterNouveauxPleinsAuto (+34 more)
...
Cohesion: 0.06
Nodes (36): OCR ticket parsing logic, FRENCH_MONTHS, FUEL_LABEL_MAP, initScanner(), normalizeNumericText(), parseOCRText(), scanWithGemini(), toFloat() (+28 more)
...
Cohesion: 0.23
Nodes (25): _buildTypeToggle(), _updateHeaderBadges(), FUEL_KEYS, clearDraft(), onStationChange(), resetForm(), applyPricesResult(), _cget() (+17 more)
...
Cohesion: 0.15
Nodes (25): Historical price resolution — nearest-prior sector/station price for past fills, APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), initHistoireDelete(), refreshAfterPlein(), applyHistPriceToForm — fill form with historical price for past date (W60), applyHistPriceToForm() (+17 more)
...
Cohesion: 0.13
Nodes (20): checkDuplicate(), initVoiceKm(), onKmInput(), restoreDraft(), saveDraft(), getMaxKmForVehicule(), initStaticHandlers(), chargerStations() (+12 more)
...
Cohesion: 0.20
Nodes (13): viewchange event, _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), FUEL_CONFIG, _refreshVehBar(), t (+5 more)
...
Cohesion: 0.25
Nodes (17): Offline sync queue — localStorage queue for failed GAS POSTs, plein-added event, submitForm, getIdToken(), _getClientId(), submitForm(), clearFromQueue(), getPendingCount() (+9 more)
...
Cohesion: 0.13
Nodes (18): CHANGELOG — Suivi Conso Carburants, Axe Web app, 🎯 Backend (GAS), 🛠️ Dev / Outillage Claude, ROADMAP — Suivi E85, ☁️ Google Apps Script / Google Sheets, ✅ Idées déjà implémentées, 📋 Onglets Google Sheets (+10 more)
...
Cohesion: 0.13
Nodes (17): GS_Pleins (table Power Query), modGraphiques.bas (dashboard graphiques), modSuiviVehicule.bas, _PrixHistory / PrixHistory (prix marche), v5.20.0.0, v5.21.0.0, GS_Pleins (table Power Query), Carte Rentabilité kit E85 (+9 more)
...
Cohesion: 0.18
Nodes (14): Tableau de bord Excel, Filtres natifs dashboard (segments véhicule/carburant + chronologie), BAN_API, Modèle CO2 E85 vs essence (tank-to-wheel), E85_RENTABLE_RATIO, FUEL_ANY, FUEL_CONFIG, FUEL_SELECT (+6 more)
...
Cohesion: 0.17
Nodes (12): APP_VERSION, initVoiceKm, onKmInput, restoreDraft, initStaticHandlers, main.js, selectStationFromMap, fetchPricesByCP (+4 more)
...
Cohesion: 0.35
Nodes (11): CHANGELOG v5.13.0.0, Top 5 recommandés (priorités ROADMAP), Lesson: never CStr() a real date for re-parsing, Lesson: timeline SetFilterDateRange ignores fractional dates, Axe Excel, Top 5 recommandés en priorité, Top 5 recommandes en priorite, ROADMAP W78 — Lazy-load carte (+3 more)
...
## Knowledge Gaps
- **786 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+781 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Câblage principal app` to `Architecture générale`, `Relevé prix quotidien GAS`, `Calculs surconso et CO2`, `Reprises de session`, `Changelog suppressions`, `Service Worker push prix`, `Aperçu filigrane Z900`, `Avancement ouverture arrière-plan`, `Workflows CI et déploiement`, `Carte plein écran`, `Tests prix historique`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `CLAUDE.md — Instructions Claude Code` connect `Relevé prix quotidien GAS` to `Changelog versions 2-3`, `Photos Z900 vertes`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `Suivi Conso Carburants — App` connect `Relevé prix quotidien GAS` to `Navigation et fix VBA`?**
