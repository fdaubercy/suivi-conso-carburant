...
## Corpus Check
- 6 files · ~673,767 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2229 nodes · 3770 edges · 318 communities (143 shown, 175 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 156 edges (avg confidence: 0.79)
...
## Communities (318 total, 175 thin omitted)

### Community 0 - "Auth et paramètres app"
Cohesion: 0.06
Nodes (70): Flux d'authentification Google — GIS One-Tap → JWT → session localStorage, LWW parameters sync — last-write-wins reconciliation across app/Excel/GAS, Offline sync queue — localStorage queue for failed GAS POSTs, auth-changed CustomEvent — émis à chaque (dé)connexion Google, authEnabled(), _avatarHtml(), _b64urlToJson(), _clearSession() (+62 more)
...
Cohesion: 0.04
Nodes (48): [2.12.1.0] — 2026-05-27, [2.13.0.0] — 2026-05-27, [2.14.0.0] — 2026-05-28, [2.15.0.0] — 2026-05-28, [2.17.0.0] — 2026-05-28, [2.4.5.1] — 2026-05-25, [2.5.0.0] — 2026-05-25, [2.8.0.0] — 2026-05-26 (+40 more)
...
Cohesion: 0.08
Nodes (39): plein-added event, viewchange event, submitForm, promptLogin(), checkDuplicate(), _getClientId(), initVoiceKm(), onKmInput() (+31 more)
...
Cohesion: 0.05
Nodes (41): [2.11.0.0] — 2026-05-27, [2.12.0.0] — 2026-05-27, [2.16.0.0] — 2026-05-28, [2.4.3.0] — 2026-05-25, [2.4.4.0] — 2026-05-25, [2.4.5.0] — 2026-05-25, [2.6.0.0] — 2026-05-25, [2.7.0.3] — 2026-05-26 (+33 more)
...
Cohesion: 0.11
Nodes (30): _allRecords, buildHistoriqueCSV(), chargerHistorique(), CSV_COLS, _csvSep(), _downloadCSV(), escapeHtml(), estPleinValide() (+22 more)
...
Cohesion: 0.20
Nodes (27): DOM helper functions, _buildTypeToggle(), _updateHeaderBadges(), FUEL_KEYS, clearDraft(), onStationChange(), resetForm(), applyPricesResult() (+19 more)
...
Cohesion: 0.15
Nodes (24): Historical price resolution — nearest-prior sector/station price for past fills, APP_TOKEN (S6 token partagé GAS/VBA), GAS_URL, GOOGLE_CLIENT_ID (auth U7 GIS), initHistoireDelete(), refreshAfterPlein(), applyHistPriceToForm — fill form with historical price for past date (W60), applyHistPriceToForm() (+16 more)
...
Cohesion: 0.12
Nodes (19): OCR ticket parsing logic, cacheStationCoords(), applyTicketStation(), fillFormFromTicket(), FRENCH_MONTHS, FUEL_LABEL_MAP, initScanner(), normalizeNumericText() (+11 more)
...
Cohesion: 0.13
Nodes (17): GS_Pleins (table Power Query), modGraphiques.bas (dashboard graphiques), modSuiviVehicule.bas, _PrixHistory / PrixHistory (prix marche), v5.20.0.0, v5.21.0.0, Empreinte CO2 E85 vs essence, GS_Pleins (table Power Query) (+9 more)
...
Cohesion: 0.38
Nodes (6): _fetchPricesNearUser(), initTypeToggle(), registerPriceCallback(), setType(), FUEL_CONFIG, state
...
## Knowledge Gaps
- **793 isolated node(s):** `_comment`, `_doc`, `_scopes`, `scriptId`, `sheetId` (+788 more)
...
- **Why does `ROADMAP — Suivi E85` connect `Moteur de carte unifié` to `Changelog migration 3.10`, `Utilitaires enseignes`, `Clés localStorage et constantes`, `Installation et mise à jour`, `Relevé prix quotidien GAS`, `Tuiles budget et CO2`, `Modules sync VBA`, `Changelog version 5`, `Manifeste PWA`, `Splash démarrage Excel`, `Gestion fichiers VBA`, `Changelog stats live`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `CLAUDE.md — Instructions Claude Code` connect `Changelog version 5` to `Changelog versions 2-3`, `Hooks settings`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `Suivi Conso Carburants — App` connect `Changelog version 5` to `Détection drift VBA`?**
