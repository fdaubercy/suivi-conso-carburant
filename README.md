...
| ⚙️ **Réglages** | Réglages **regroupés par bloc repliable** (v4.1/v4.2) : **🚀 démarrage** (vue d'ouverture), alertes prix par carburant (alerte + seuil groupés), **conversion E85** (coût total paramétrable : boîtier + pose + carte grise + entretien + surcoût assurance − aide, **carburant de référence** SP98/SP95/E10 + écart €/L, nb pleins récents pour la projection — X67/X68/X69/X70), **budget mensuel**, **objectif CO₂ annuel** |
