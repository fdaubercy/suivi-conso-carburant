...
' ============================================================
'  modGraphData - Agregats dashboard (X44 P3/P4)
' ============================================================
'  BuildAggregates (orchestration) + helpers, extraits de modGraphiques.
'  X44 P4 : les sous-blocs (prix/conso/vehicules) sont dans modGraphBlocks
'  (qui appelle les helpers Public ci-dessous). Config via modGraphCfg.
'  Public : BuildAggregates, EnsureDataSheet, EnsurePeriodNames, KitCost,
...
Public Function LCIdx(lo As ListObject, nm As String) As Long
    On Error Resume Next
...
Public Function NumDict(d As Object, k As String) As Double
    If d.Exists(k) Then NumDict = d(k) Else NumDict = 0
End Function


Public Function FuelKey(T As String) As String
...
Public Sub TriStr(arr() As String)
